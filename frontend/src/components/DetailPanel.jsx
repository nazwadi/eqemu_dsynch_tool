...
// Right-hand detail panel, shared by all three tabs — one component whose body branches on
...
function DetailPanel({
    ...
    selectedNpc,
    selectedSpawnRow, selectAllSharingSpawngroup, openSyncSpawnGroupEntriesPreview,
